...
<el-button type="primary" size="large" class="dl-btn" @click="download('/downloads/XiaopacaiParent-1.1.1-arm64-v8a.apk')">
            下载 APK（arm64-v8a · 推荐）
          </el-button>
<el-button size="large" class="dl-btn dl-btn-sub" @click="download('/downloads/XiaopacaiParent-1.1.1-armeabi-v7a.apk')">
            下载 APK（armeabi-v7a）
          </el-button>
<el-button size="large" class="dl-btn dl-btn-sub" @click="download('/downloads/XiaopacaiParent-1.1.1-x86_64.apk')">
            下载 APK（x86_64 · 模拟器）
          </el-button>
        </el-card>
